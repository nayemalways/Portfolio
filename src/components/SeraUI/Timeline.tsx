...
const timelineData: TimelineItemData[] = [
  {
    ...
    type: "Full-time",
    duration: "20 Octobor, 2025 — Present",
    icon: Code,
    responsibilities: [
      "Lead development of complex Node.js applications with TypeScript.",
      "Architect scalable backend solutions using Express.js and modern tooling.",
      "Mentor junior developers and conduct code reviews.",
      "Collaborate with design and frontend teams to deliver high-quality products.",
    ],
    skills: [ "Node.js" , "Express.js", "TypeScript", "MongodB", "PostgreSQL", "Socket.io"],
  },
  {
    id: "prof-exp-2",
    title: "Frontend Developer",
    type: "Full-time",
    duration: "15 July, 2025—09 - 14 Octobor, 2025 (3 months)",
    icon: Code,
    responsibilities: [
      "Developed responsive web applications using Squarespace, Wix.",
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-2 flex-1">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-base font-semibold text-slate-50 dark:text-slate-900">
                    {item.title}
                  </h3>
                </div>
...
export default function Timeline() {
  return (
    <div className="relative z-0 transition-colors duration-300 flex-1  ">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight text-slate-50 dark:text-slate-900 mb-3">
