  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="relative z-10 whitespace-nowrap text-lg font-semibold flex items-center gap-2">
          {children}
        </span>
      </div>
    </button>
...
export default function SeraButtonView() {
  return (
    <div className="flex gap-1 lg:gap-5 max-lg:justify-center">
      <a href="#contact">
      ...
      />
      <path fill="#4d4d4d" d="M15,18h2a1,1,0,0,0,0-2H15a1,1,0,0,0,0,2Z" />
      </svg>

        <p>Hire Me</p>
        </GlowButton>
      </a>
      <a href="https://drive.google.com/file/d/1GfXfOKiZZ3ML9_32sXAThzhyhdmpi-4l/view?usp=sharing" target="_blank">
