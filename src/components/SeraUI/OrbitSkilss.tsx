  ...
  mongodb: {
    component: () => (
      <svg viewBox="0 0 24 24" className="w-full h-full" fill="currentColor">
        <path
          d="M12 0s-3.75 3.61-3.75 8.438c0 3.18 2.08 5.912 3.287 7.187.292.31.173 2.33.463 3.09h.02c.29-.76.17-2.78.463-3.09 1.206-1.275 3.287-4.007 3.287-7.187C15.75 3.61 12 0 12 0z"
          fill="#47A248"
        />
      </svg>
    ),
...
export default function OrbitingSkills() {
  ...
  const orbitConfigs: Array<{
    ...
    { radius: 180, glowColor: "purple", delay: 1.5 },
      { radius: 270, glowColor: "pink", delay: 3 },
  ];

  return (
    <div className="w-full flex items-center justify-center overflow-hidden flex-1 -z-50">
      {/* Background pattern */}
