...
const ContactSection = () => {
  return (
    <section
      id="contact"
      className="relative w-full py-22 md:py-34 container  text-purple-600"
    >
      ...
      <div className="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="w-full md:w-1/2 p-5 md:px-0 mx-5">
          <div className="bg-gray-900 border border-slate-600 w-full lg:w-1/2 h-full p-5 pt-8">
            <h3 className="text-2xl font-semibold mb-5">My Social Media</h3>

            {/* list */}
            <div className="flex flex-col gap-3">
              <a
                href="https://github.com/nayemalways"
                target="_blank"
                className="flex items-center hover:text-white hover:bg-purple-600 p-2"
              >
                <svg
                  fill="currentColor"
              ...
              <a
                href="https://linkedin.com/in/nayemalways"
                target="_blank"
                className="flex items-center hover:text-white hover:bg-purple-600 p-2"
              >
                <svg
              ...
              <a
                href="https://facebook.com/nayemalways"
                target="_blank"
                className="flex items-center hover:text-white hover:bg-purple-600 p-2"
              >
                <svg
        ...
        >
          ...
          <div className="w-full pt-3">
            <button
              type="submit"
              className="w-full bg-gray-900 border border-purple-600 px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-purple-600 hover:text-white text-xl cursor-pointer"
            >
              Send
            </button>
          </div>
