...
export const AboutSection = () => {
  return (
    <div id="about" className="container max-sm:pt-38 max-lg:pt-48"> 
          <div className="flex rounded-br-4xl flex-col lg:flex-row justify-between bg-cover bg-no-repeat px-2 md:px-12 py-14 md:py-12" style={{ backgroundImage: `url(${pinkGlow})` }}>
                <div className="flex-1 self-center" >
                    ...
                    <p className="max-w-xl text-center text-wrap md:text-left py-4 lg:pt-12 text-slate-300 lg:text-xl md:text-lg text-sm">
